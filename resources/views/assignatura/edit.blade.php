            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Editar Asignatura existente</span>
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('assignaturas.index') }}"> Volver</a>
                        </div>
                    </div>
                    @if (($assignatura!=null))
                    <div class="card-body">
                        <form method="POST" action="{{ route('assignaturas.update', $assignatura->codi) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf

                            @include('assignatura.form')

                            </form>
                    </div>
                    @else
                <p>     
            Esta asignatura no existe
                </p>
