            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Edición de Microcontingut</span>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('microcontinguts.update', $microcontingut->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf

                            @include('microcontingut.form')
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <div class="">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Edición de Microcontenido</span>
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('microcontinguts.index') }}"> Volver</a>
                        </div>
                    </div>
