            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Editar Grado existente</span>
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('graus.index') }}"> Volver</a>
                        </div>
                    </div>
                    @if (($grau!=null))
                    <div class="card-body">
                        <form method="POST" action="{{ route('graus.update', $grau->nom) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
