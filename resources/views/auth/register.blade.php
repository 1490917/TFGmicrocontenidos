                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="niu" type="text" class="form-control @error('niu') is-invalid @enderror" name="niu" value="{{ old('niu') }}" required autocomplete="niu" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="idioma" id="idioma" requiered>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="tipus" id="tipus" requiered>
